...
Route::post('/product/fetch', 'App\Http\Controllers\ProductController@fetchData')->name('product.fetch');
Route::get('/products', 'App\Http\Controllers\ProductController@search')->name('products');
Route::get('/product/show/{slug}', 'App\Http\Controllers\ProductController@show')->name('products.show');
Route::get('/product/edit/{slug}', 'App\Http\Controllers\ProductController@edit')->name('products.edit');
Route::put('/product/update/{id}', 'App\Http\Controllers\ProductController@update')->name('products.update');
