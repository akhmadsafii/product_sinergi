<aside class="main-sidebar">
	<section class="sidebar">
		<ul class="sidebar-menu" data-widget="tree">
			...
			@endif
			<li class="treeview 
				{{ Request::segment(1) === 'product' ? 'active menu-open' : null }}
				...
				<ul class="treeview-menu">
					@if (Auth::user()->can('root-dev', ''))
						<li class="{{ Request::segment(1) === 'product' && Request::segment(2) === null ? 'active' : null }}">
							<a href="{{ route('product') }}" title="App Config">
								<i class="fa fa-product-hunt"></i> <span> Get Product</span>
							</a>
						</li>
					@endif					
					<li class="
						{{ Request::segment(1) === 'products' ? 'active' : null }}
						">
						<a href="{{ route('products') }}" title="Users">
							<i class="fa fa-search"></i> <span> Filter Product</span>
						</a>
					</li>
				</ul>
			</li>      
